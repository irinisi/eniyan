...
VAULT_PATH = Path(os.environ.get("TEAMOS_VAULT_PATH", Path(__file__).resolve().parents[2] / "vault"))
...
BACKUP_DIR = Path(os.environ.get("TEAMOS_BACKUP_DIR", VAULT_PATH.parent / "backups"))
